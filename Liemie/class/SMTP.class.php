...
class SMTP {
    ...
    // De Qui
    var $From = 'magmasters@alwaysdata.net';// Adresse de l' expéditeur
    var $FromName = 'Kaliemie';// Nom de l' expéditeur
    var $ReplyTo = 'magmasters@alwaysdata.net';// Adresse de retour
    var $org = 'Kaliemie'; // Organisation
...
//------------------------------------------------------------------------------
    ...
    function Connect_SMTP(){
		...
		if(!$this->CHARSET){ $this->CHARSET = mb_internal_encoding("UTF-8"); }
